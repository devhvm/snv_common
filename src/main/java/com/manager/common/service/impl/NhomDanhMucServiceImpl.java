...
public class NhomDanhMucServiceImpl implements NhomDanhMucService {
    ...
    private final Logger log = LoggerFactory.getLogger(NhomDanhMucServiceImpl.class);

    private final NhomDanhMucRepository nhomDanhMucRepository;

    private final NhomDanhMucMapper nhomDanhMucMapper;

    public NhomDanhMucServiceImpl(NhomDanhMucRepository nhomDanhMucRepository, NhomDanhMucMapper nhomDanhMucMapper) {
    ...
    public void delete(Long id) {
        log.debug("Request to delete NhomDanhMuc : {}", id);        nhomDanhMucRepository.deleteById(id);
    }
}
